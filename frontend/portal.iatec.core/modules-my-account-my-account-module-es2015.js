...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CentralDownloadsComponent", function() { return CentralDownloadsComponent; });
...
/* harmony import */ var _services_central_download_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/central-download.service */ "./src/app/modules/my-account/services/central-download.service.ts");
...
let CentralDownloadsComponent = class CentralDownloadsComponent {
    constructor(formBuilder, operationService, centralDownloadService) {
    ...
    setOperation() {
        const operation = this.operations.find(el => el.operacaoId === this.formSearch.value.operation);
    ...
    search() {
        if (this.formSearch.valid) {
            ...
            const initialDate = moment__WEBPACK_IMPORTED_MODULE_5__(form.initialDate).format('YYYY-MM-DD');
            const finalDate = moment__WEBPACK_IMPORTED_MODULE_5__(form.finalDate).format('YYYY-MM-DD');
            const activity = form.activity || '';
            this.centralDownloadService.getListDownloads(activity, form.status, form.type, initialDate, finalDate, (this.pageIndex + 1).toString(), this.pageSize.toString()).subscribe(response => {
                this.loading = false;
                this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_6__["MatTableDataSource"](response.data);
    ...
    getDownload(file) {
        this.centralDownloadService.getFile(file.url).subscribe(response => {
...
CentralDownloadsComponent.ctorParameters = () => [
...
CentralDownloadsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-central-downloads',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./central-downloads.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/my-account/central-downloads/central-downloads.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./central-downloads.component.scss */ "./src/app/modules/my-account/central-downloads/central-downloads.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"],
        src_app_services_operation_service__WEBPACK_IMPORTED_MODULE_3__["OperationService"],
        _services_central_download_service__WEBPACK_IMPORTED_MODULE_4__["CentralDownloadService"]])
], CentralDownloadsComponent);
...
/* harmony import */ var _central_downloads_central_downloads_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./central-downloads/central-downloads.component */ "./src/app/modules/my-account/central-downloads/central-downloads.component.ts");




const routes = [
    { path: 'central-downloads', component: _central_downloads_central_downloads_component__WEBPACK_IMPORTED_MODULE_3__["CentralDownloadsComponent"] },
];
...
/* harmony import */ var _my_account_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./my-account-routing.module */ "./src/app/modules/my-account/my-account-routing.module.ts");
/* harmony import */ var _central_downloads_central_downloads_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./central-downloads/central-downloads.component */ "./src/app/modules/my-account/central-downloads/central-downloads.component.ts");
...
MyAccountModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _central_downloads_central_downloads_component__WEBPACK_IMPORTED_MODULE_4__["CentralDownloadsComponent"]
        ],
        imports: [
            ...
            _my_account_routing_module__WEBPACK_IMPORTED_MODULE_3__["MyAccountRoutingModule"]
        ]
    })
], MyAccountModule);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CentralDownloadService", function() { return CentralDownloadService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
let CentralDownloadService = class CentralDownloadService {
    constructor(http) {
        this.http = http;
    }
    getListDownloads(atividadeId, statusId, tipoId, dataInicial, dataFinal, pageIndex, pageSize) {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].urlServices}/api/v1/central-downloads`, {
            params: {
...
CentralDownloadService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] }
];
CentralDownloadService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
//# sourceMappingURL=modules-my-account-my-account-module-es2015.js.map